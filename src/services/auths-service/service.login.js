...
var serviceLogin = function (payload) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var checkUser, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, databases_1["default"]('users')
                            .select()
                ...
                case 1:
                    ...
                    return [3 /*break*/, 5];
                case 2:
                    if (!(checkUser[0].active === false)) return [3 /*break*/, 3];
                    resolve({
                        status: 403,
                        message: 'account is not active, please resend new activation token'
                    });
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, databases_1["default"]('users')
