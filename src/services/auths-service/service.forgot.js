...
var serviceForgot = function (payload) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, databases_1["default"]('users').where({ userId: checkUser[0].userId }).update({ password: uuid_1.v4(), updatedAt: new Date() })];
                case 3:
                    _a.sent();
                    resolve({
                        status: 200,
