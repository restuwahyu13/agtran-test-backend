...
var serviceUpdateUser = function (payload) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var checkUser, updateUseAccount, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, databases_1["default"]('users').select().where({ userId: payload.id }).returning('*')];
                case 1:
                    checkUser = _a.sent();
                    if (!(checkUser.length < 1)) return [3 /*break*/, 2];
                    resolve({
                        status: 404,
                        message: "user account is not exist for this id " + payload.id
                    });
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, databases_1["default"]('users').where({ userId: checkUser[0].userId }).update({
