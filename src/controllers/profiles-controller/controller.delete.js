...
var service_delete_1 = require("../../services/profiles-service/service.delete");
var deleteUserController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, _a, status_1, message;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1: return [4 /*yield*/, service_delete_1.serviceDeleteUser({ id: req.params.id })];
            case 2:
