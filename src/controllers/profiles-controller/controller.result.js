...
var resultUserController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, _a, status_1, message, data;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1: return [4 /*yield*/, services_1.service.serviceResultUser({ id: req.params.id })];
            case 2:
