...
var template_reset_1 = require("../../templates/template.reset");
var forgotController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1: return [4 /*yield*/, services_1.service.serviceForgot({ email: req.body.email })];
            case 2:
            ...
            case 3:
                ...
                template = template_reset_1.tempMailReset(data[0].email, accessToken);
